...
Refresh = function(self)
    ...
    self.acBtn:SetText(W.AttrPickText(char.ac_attribute, sheet.derived.ac_attribute))
    self.initBtn:SetText(W.AttrPickText(char.init_attribute, sheet.derived.init_attribute))
